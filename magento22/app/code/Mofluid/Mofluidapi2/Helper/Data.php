   ...
   /*=========================================================== */
    ...
    public function ws_addCartProduct($store,$customer_id,$products)
    {
		...
		try
		{
	     ...
	     {
		   $product = $this->listingHelper->getProduct($product['id']);
		   ...
		   else if ($product['type'] == "configurable")
		   {
	          $params = array(
              'product' => $product['id'],
              'selected_configurable_option' => $product['selected_configurable_option'],
              'super_attribute' => $product['super_attribute'],
